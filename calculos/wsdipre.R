# Kike, 9-3-2018
# Ahora mismo el programa esta preparado para calcular
# en periodos de clima presente, entrando como argumentos
# el nc de 1971-2000 y el nombre del fichero de salida
# que guarda WSDI en media a 30 años y el maximo de los 30 años
# Hay otro programa similar para futuro, 2071-2100, porque
# hay que cambiar, hasta donde he probado, el base.range
# Genera un nc de salida, para pintar con ferret, hasta que
# mejoremos en la representacion con raster desde R.
# Los calculos con bucles for tardan algo mas de 1h para
# los 30 años, en hpc, y los argumentos se configuran en un script
# para lanzar a las colas de hpc con sbatch.
...
#    xdias<-seq(1,10950)
    ...
    circm<-climdexInput.raw(vv,vv,vv,tt,tt,tt, base.range=c(1971,2000))
